...
namespace Assets.Infrastructure
{
    public partial class AsteroidFactory : Factory<Asteroid>
    {
        ...
        public AsteroidFactory(TickableManager tickable, AsteroidConfig configuration, ParticleAsteroidConfig smallAsteroidConfig, RemoteAnalytics analytics,Ads ads)
            : base(tickable, configuration, analytics,ads)
        {
